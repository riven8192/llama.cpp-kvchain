...
void llama_memory_hybrid_iswa::state_write(llama_io_write_i & io, llama_seq_id seq_id, llama_state_seq_flags flags, llama_pos pos_limit) const {
    mem_attn->state_write(io, seq_id, flags, pos_limit);
    mem_recr->state_write(io, seq_id, flags, pos_limit);
}

void llama_memory_hybrid_iswa::state_read(llama_io_read_i & io, llama_seq_id seq_id, llama_state_seq_flags flags, llama_pos pos_limit) {
    mem_attn->state_read(io, seq_id, flags, pos_limit);
    mem_recr->state_read(io, seq_id, flags, pos_limit);
}
