...
struct mock_memory : public llama_memory_i {
    ...
    void state_write(llama_io_write_i &, llama_seq_id, llama_state_seq_flags, llama_pos) const override { GGML_ASSERT(false && "not implemented"); }
    void state_read (llama_io_read_i &,  llama_seq_id, llama_state_seq_flags, llama_pos) override { GGML_ASSERT(false && "not implemented"); }
};
